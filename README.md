...
4. To run the unit tests, press `⌘U`. All 14 tests should pass without a network connection.

Once running, tap **Get started**, choose one or more genres along with how much time you have and an airing status, then tap **Suggest me something**. From there, either accept the suggestion with **I'll watch this** or press **Already seen it? Show me another one** to be given the next one.
